...
**zespołu wsparcia klientów** i **zespołu marketingowego**. Wyznaczony jest Produkt Manager i (przy większej liczbie osób w podzespołach) wszystkie podzespoły mają swoich "leadów". Produkt Manager i "leadzi" dbają o to, aby oprogramowanie "działało" i rozwijało się, aby pojawiali się nowi klienci i aby aktualni klienci byli zadowoleni z korzystania z oprogramowania (produktu). 
